...
class SubmapQueryResponse(genpy.Message):
  _md5sum = "3c37fcfc4b7e1950cde35254d0f962e9"
...
float64 w
"""
  __slots__ = ['submap_version','textures','error_message']
  _slot_types = ['int32','cartographer_ros_msgs/SubmapTexture[]','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       submap_version,textures,error_message
...
class SubmapQuery(object):
  ...
  _md5sum = '274558cc713c30123c26c8267e25946b'
