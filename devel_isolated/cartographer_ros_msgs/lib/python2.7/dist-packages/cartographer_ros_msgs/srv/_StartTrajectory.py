...
class StartTrajectoryRequest(genpy.Message):
  _md5sum = "d4207fb3c00f498e7b5d4977380c378f"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2B4i3d.pack(_x.options.provide_odom_frame, _x.options.use_odometry, _x.options.num_laser_scans, _x.options.num_multi_echo_laser_scans, _x.options.num_subdivisions_per_laser_scan, _x.options.num_point_clouds, _x.options.rangefinder_sampling_ratio, _x.options.odometry_sampling_ratio, _x.options.imu_sampling_ratio))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.options.provide_odom_frame, _x.options.use_odometry, _x.options.num_laser_scans, _x.options.num_multi_echo_laser_scans, _x.options.num_subdivisions_per_laser_scan, _x.options.num_point_clouds, _x.options.rangefinder_sampling_ratio, _x.options.odometry_sampling_ratio, _x.options.imu_sampling_ratio,) = _struct_2B4i3d.unpack(str[start:end])
...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_i.pack(self.trajectory_id))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.trajectory_id,) = _struct_i.unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class StartTrajectory(object):
  ...
  _md5sum = 'fef8542380e509d8c8253b1d28b51e25'
