...
class csv2Topi():
    ...
    def fastReadCSV(self,GNSSBegin, GNSSEnd):
        ...
        self.Fcsv_GNSS = csv.reader(open('/home/wenws/20180209/1/sv_data820180209.csv',
...
if __name__ == '__main__':
    ...
    csv2Topi_ = csv2Topi()
    csv2Topi_.fastReadCSV(484116000,484325000) # the value is provided by bag file in topci '/novatel_data/bestpos'
